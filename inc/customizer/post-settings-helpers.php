...
function banker_insert_related_inline_content($content, $settings)
{
    ...
    $related_html = '<div class="banker-related-inline py-0 text-[14px] flex-col">'
    ...
    // Fallback: if position didn't match due to too-few paragraphs, append at end
    if (!$inserted) {
        $processed .= $related_html;
    }
