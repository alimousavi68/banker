...
<body>
  <div>
    ...
    <header class=" bg-white">
      <div class="max-w-[1400px] mx-auto px-4 sm:px-4 lg:px-6 border-b border-border py-1 flex gap-4  items-center justify-between print:hidden">
        ...
        <div class="flex gap-2">
          ...
          <?php if ($social_links['instagram']): ?>
            <a href="<?php echo esc_url($social_links['instagram']); ?>" target="_blank" class="block bg-lightBg rounded-[1px] p-[3px] group cursor-pointer">
      ...
      <?php if (function_exists('banker_render_news_ticker')) {
        banker_render_news_ticker();
      } ?>
