    ...
    <?php if ($small_history_query->have_posts()) : ?>
      <div class="flex flex-col md:flex-row mt-4  gap-4">
        <div class="w-full md:w-1/2 md:border-l md:ml-4 md:pl-4 border-border">
          ...
          ?>
            <a href="<?php the_permalink(); ?>" class="flex <?php echo $border_class; ?> group border-border gap-4 py-4  cursor-pointer transition duration-300 no-underline">
              <!-- تصویر -->
              ...
              <!-- متن -->
              <div class="flex flex-col gap-3 align-start">
                <h6 class="font-semibold text-black text-[16px] transition-colors duration-300 group-hover:text-secondary line-clamp-2">
                  <?php the_title(); ?>
                </h6>
              </div>
          ...
          <a href="<?php the_permalink(); ?>" class="block overflow-hidden group no-underline border-b border-border mb-2">
            ...
            <div class="<?php echo ($notes_count < 3) ? 'border-b border-border' : ''; ?> py-4 text-right">
              <div class="flex gap-3">
                ...
                <p class="font-normal text-black transition-colors duration-300 group-hover:text-secondary line-clamp-2">
                  <?php the_title(); ?>
                </p>
              </div>
