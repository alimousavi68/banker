...
<div class=" border-b border-border pb-4">
    ...
    <div class="mb-6">
         ...
         <h1 class="post-title entry-title text-[30px] md:text-[28px] lg:text-[30px] leading-normal leading-[1.9] font-bold text-gray-900">
              <?php the_title(); ?>
          </h1>
        ...
        <div class="flex flex-col  gap-6">
            ...
            <div class="w-full flex flex-col lg:flex-row lg:gap-0 gap-1 lg:items-center justify-start">
                <!-- Title: full width -->
                    <?php
                    if (get_post_meta(get_the_ID(), '_banker_note_author', true)):
                        $note_author_image = get_post_meta(get_the_ID(), '_banker_note_author_image', true);
                        $image_url = wp_get_attachment_image_url($note_author_image, 'thumbnail');
                    ?>
                        <div class="flex flex-row gap-2 lg:flex-col items-center align-items-start lg:gap-0 w-[58px] lg:w-[148px]  align-content-start ">
                            <img src="<?php echo esc_url($image_url); ?>" class="lg:w-18 lg:h-18 w-12 h-12 !rounded-full grayscale object-cover !mb-3">
                            <span class="text-sm font-medium"><?php echo esc_html(get_post_meta(get_the_ID(), '_banker_note_author', true)); ?></span>
                        </div>
                    <?php endif; ?>
